...
import '../controllers/auth/forgot_create_password_controller.dart';
import '../network_services/app_consts.dart';

class ForgotCreatePasswordScreen extends StatelessWidget {
  ForgotCreatePasswordScreen({super.key});

  RxBool isObscure = true.obs;

  ForgotCreatePasswordController controller =
      Get.put(ForgotCreatePasswordController());
