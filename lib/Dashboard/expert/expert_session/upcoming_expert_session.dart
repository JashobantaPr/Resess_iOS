...
import '../../../controllers/expert/expert_session_controller.dart';

class UpcomingExpertSession extends GetWidget<ExpertSessionController> {
  UpcomingExpertSession({super.key});

  @override
  Widget build(BuildContext context) {
    return Container(
      color: AppColors.appBg,
      child: controller.expertUpcomingData.isEmpty
          ? Container(child: Text("No bookings found for this expert."))
          : ListView.separated(
              itemCount: controller.expertUpcomingData.length,
              itemBuilder: (context, position) {
                return learningSessionItem(
                    item: controller.expertUpcomingData[position]);
              },
        ...
        children: [
          ...
          Text.rich(
            TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text: item?.levelOfSubjectKnowledge ??
                      "", // Change this to "Beginner"
